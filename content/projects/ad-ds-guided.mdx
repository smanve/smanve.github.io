...
summary: "Promoted a server to a DC, designed OUs, automated user/group setup, enforced password policies, and applied security baselines with GPO — focusing on what actually breaks and how to fix it."
date: "2025-08-13"
