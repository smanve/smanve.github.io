...
>
  {content}
      ...
      <div className="flex gap-4">
        {frontmatter.repo && <a className="underline" href={frontmatter.repo} target="_blank">GitHub</a>}
        {frontmatter.demo && <a className="underline" href={frontmatter.demo} target="_blank">Live</a>}
      </div>
    </main>
  );
}
